...
public class MyListTest {
  ...
  private MyList<Integer> initializeIntegerList () {
    //List with size equal to initial capacity. There is no additional test for resize() method
    return new MyList<>(new Integer[] {18, 93, 7, -256, -534523, 5223, 6828, 7, 134, 2345});
  }

  @Test
  // Adding random element is checked
  public void should_add_random_element() {
    MyList<Integer> integerList = initializeIntegerList();
  ...
  private Byte[] initializeByteArray() {
    return new Byte[] {23, 34, -52, 22, 19, 18, -17, 127, 100, -6};
  }

  @Test
  public void should_get_element_with_random_correct_index() {
    Byte[] byteArray = initializeByteArray();
  ...
  private Float[] initializeFloatArray () {
    return new Float[] {74.12f, -54.8234f, 7.929f, -95.2f, -30.924f, -14255.9243f, 94.4234f, 56.97234f, -342.4256f};
  }

  @Test
  //Test of random index element remove
  public void should_remove_element() {
    Float[] floatArray = initializeFloatArray();
  ...
  private MyList<Double> initializeFirstDoubleList () {
    return new MyList<>(new Double[]{52.134, -254.23, 44.452, 852.92});
  }

  @Test
  public void should_map_list_1 () {
    MyList<Double> doubleList = initializeFirstDoubleList();
  ...
  private MyList<Double> initializeSecondDoubleList() {
    return new MyList<>(new Double[] {23.234, -234255.24, 72.2345, 15.569, -12.22});
  }
  @Test
  public void should_be_equal_same_reference() {
    MyList<Double> doubleList = initializeSecondDoubleList();
  ...
  private MyList<Short> initializeShortList() {
    return new MyList<>(new Short[]{-23, 435, 17, 43, 1, 12, 4256, 11222});
  }

  @Test
  public void should_be_consistent_hashcode() {
    MyList<Short> shortList = initializeShortList();
